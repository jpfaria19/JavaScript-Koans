...
test("array type", function () {
  ...
  // In JS, arrays are of type "object".
});
...
test("splice", function () {
  ...
  // The splice method removes elements from an array. The first parameter is the start index, and the second is the number of elements to remove.
});
...
test("queue methods", function () {
  ...
  // The unshift method adds elements to the beginning, and shift removes the first element.
});
