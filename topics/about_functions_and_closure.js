...
test("self invoking functions", function () {
  ...
  equal("string", typeof publicValue, "is publicValue available in this context?");
  // Self-invoking functions create a new scope. secretValue is only available inside the function.
});
...
test("arguments array", function () {
  ...
  // The arguments object contains all arguments passed to the function, allowing us to sum them.
});
